...
class CallRecordAdmin(ModelView, model=CallRecord):
    ...
    column_labels = {
        ...
        CallRecord.recording_path: "录音文件",
        CallRecord.recording_status: "录音状态",
        CallRecord.recording_mime_type: "录音格式",
        CallRecord.recording_size_bytes: "录音大小",
