...
def _replay_cases() -> list[ReplayCase]:
    ...
    return [
        ...
        ReplayCase(
            name="pipeline_unanswered_customer_question_fails_score",
            note="来自 2026-07-06 实测：Pipeline 听到客户问为什么不说话，但等 final 到达时媒体已经断开，不能被评分成通过。",
            events=[
                _event("call_connected", "pipeunanswered", "2026-07-06T01:50:20.915Z"),
                _event("call_context_attached", "pipeunanswered", "2026-07-06T01:50:20.915Z", requestedRoute="pipeline", effectiveRoute="pipeline"),
                _event("omni_start_failed_fallback", "pipeunanswered", "2026-07-06T01:50:20.916Z", error="本通电话在前端选择稳定分段语音 Pipeline。"),
                _event("human_speech_confirmed", "pipeunanswered", "2026-07-06T01:50:22.262Z", text="喂。"),
                _event("llm_reply", "pipeunanswered", "2026-07-06T01:50:23.548Z", reply="您好，我在。"),
                _event("tts_start", "pipeunanswered", "2026-07-06T01:50:23.968Z", raw={"sentBytes": 640, "firstAudioMs": 419}),
                _event("asr_partial", "pipeunanswered", "2026-07-06T01:50:38.610Z", text="不行。你好，你说"),
                _event("turn_waiting_final", "pipeunanswered", "2026-07-06T01:50:38.611Z", text="不行。你好，你说"),
                _event("call_error", "pipeunanswered", "2026-07-06T01:50:40.676Z", error="AudioSocket connection closed."),
                _event("asr_final", "pipeunanswered", "2026-07-06T01:50:40.900Z", text="不行，你好，你说为什么不说话？"),
                _event("call_disconnected", "pipeunanswered", "2026-07-06T01:50:40.933Z"),
            ],
            expected_state="closed",
            required_true_flags=("humanSpeechConfirmed", "aiSpeechConfirmed"),
            expected_last_customer_contains="为什么不说话",
            expected_score_status="fail",
        ),
        ReplayCase(
            name="omni_fee_question_after_long_wait_fails_score",
            note="来自 2026-07-06 实测：Omni 后半段已听到怎么收费，但挂断后才提交回复，不能被评分成通过。",
            events=[
                _event("call_connected", "omniunanswered", "2026-07-06T02:04:05.125Z"),
                _event("call_context_attached", "omniunanswered", "2026-07-06T02:04:05.125Z", requestedRoute="omni", effectiveRoute="omni"),
                _event("human_speech_confirmed", "omniunanswered", "2026-07-06T02:04:08.900Z", text="喂。"),
                _event("llm_reply", "omniunanswered", "2026-07-06T02:04:12.985Z", reply="您说，我在听。"),
                _event("tts_start", "omniunanswered", "2026-07-06T02:04:15.253Z", raw={"sentBytes": 640, "firstAudioMs": 433}),
                _event("asr_partial", "omniunanswered", "2026-07-06T02:04:40.826Z", text="你这怎么收费？"),
                _event("turn_waiting_final", "omniunanswered", "2026-07-06T02:04:40.827Z", text="你这怎么收费？"),
                _event("call_error", "omniunanswered", "2026-07-06T02:04:52.709Z", error="AudioSocket connection closed."),
                _event("asr_final", "omniunanswered", "2026-07-06T02:04:52.993Z", text="你是怎么收费的啊？"),
                _event("call_disconnected", "omniunanswered", "2026-07-06T02:04:53.044Z"),
            ],
            expected_state="closed",
            required_true_flags=("humanSpeechConfirmed", "aiSpeechConfirmed"),
            expected_last_customer_contains="怎么收费",
            expected_score_status="fail",
        ),
        ReplayCase(
