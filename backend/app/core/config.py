...
class Settings(BaseSettings):
    ...
    voice_gateway_profile: str = "uc100_sip_volte"
    ...
    voice_gateway_host: str = "192.168.10.100"
    voice_gateway_sip_port: int = 5080
    voice_gateway_trunk_name: str = ""
    voice_gateway_max_channels: int = 0
