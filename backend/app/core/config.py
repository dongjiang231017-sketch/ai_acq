...
class Settings(BaseSettings):
    ...
    # 2026-07-10 正式 LiveKit 外呼统一使用 Omni Plus + Aiden。
    dashscope_omni_realtime_model: str = "qwen3.5-omni-plus-realtime"
    dashscope_omni_realtime_url: str = "wss://dashscope.aliyuncs.com/api-ws/v1/realtime"
    dashscope_omni_realtime_voice: str = "Aiden"
    ...
    asterisk_channel_capacity_wait_seconds: float = 120.0
    asterisk_channel_capacity_poll_seconds: float = 1.0
